...
#ifndef NOVO_QT_NOVOUNITS_H
#define NOVO_QT_NOVOUNITS_H
...
/** Novo unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class NovoUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NovoUnits(QObject *parent);

    /** Novo units.
      @note Source: https://en.novo.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MBTC,
...
typedef NovoUnits::Unit NovoUnit;

#endif // NOVO_QT_NOVOUNITS_H
